// aisth-l3e5.js
// Independent runtime for Aisth Lesson 3 Exercise 5
// Circle-select: here is / there is

const EXCEL_FILE = "LTRYI-grammar-lesson-questions.xlsx";
const TARGET_LESSON = 3;
const TARGET_EXERCISE = 5;
const PAGE_LABEL = "Aisth L3-E5";
const MAX_QUESTIONS = 0; // 0 = unlimited

const FIXED_INSTRUCTION = "한국어 문장을 보고 알맞은 표현을 동그라미 치세요.";
...
let level = "aisth";
let day = "012";
let quizTitle = "quiz_Grammar_aisth_l3e5";
let userId = "";
...
function renderQuestion() {
  ...
  area.innerHTML = `
    ...
    <div class="box" style="background:#fff;">
      <div class="choice-line">(${renderOptionTokens(q.options)})</div>
