(function initHermaL1E3Round2(global) {
  "use strict";

  if (!global || global.HermaL1E3Round2) return;

  var MODULE_NAME = "HermaL1E3Round2";
  var SCRIPT_NAME = "herma-l1e3_round2.js";
  var STYLE_ID = "herma-l1e3-round2-style";
  var INSTRUCTION_KR = "\uB450 \uBB38\uC7A5\uC744 \uC57D\uBD84\uD558\uACE0 \uD55C \uBB38\uC7A5\uC73C\uB85C \uB9CC\uB4E4\uC5B4\uBCF4\uC138\uC694";
  ...
  var state = {
    ...
    level: "Basic",
    day: "103",
    quizTitle: "quiz_Grammar_Basic_103_round2",
    rawRows: [],
    questions: [],
    currentIndex: 0,
    results: [],
  ...
  function buildQuestionsFromRows() {
    ...
    state.questions = filtered.map(function (r, idx) {
      ...
      return {
        ...
        title: String(r["Title"] || "").trim() || "Herma L1-E3 Round2",
  ...
  function renderIntro() {
    ...
    area.innerHTML = [
      ...
      "    \uB450 \uBB38\uC7A5\uC744 \uC57D\uBD84\uD574 \uD55C \uBB38\uC7A5\uC73C\uB85C \uC791\uC131\uD558\uC138\uC694.",
      "  </div>",
      '  <div style="font-size:12px;line-height:1.5;color:#2b2b2b;margin-bottom:8px;">',
      "    Total Questions: " + total,
      "  </div>",
      '  <button class="r2-quiz-btn" style="width:100%; margin-top:12px;" onclick="HermaL1E3Round2.startQuiz()">Start</button>',
      "</div>"
    ].join("\n");
  }
  ...
  function renderQuestion() {
    ...
    area.innerHTML = [
      ...
      '    <button class="r2-quiz-btn" id="submit-btn" onclick="HermaL1E3Round2.submitAnswer()">\uC81C\uCD9C</button>',
      '    <button class="r2-quiz-btn" id="next-btn" onclick="HermaL1E3Round2.goNext()" disabled>\uB2E4\uC74C</button>',
      "  </div>",
      "</div>"
    ].join("\n");
  ...
  function submitAnswer() {
    ...
    state.results.push({
      ...
      word: "Herma L1-E3 Round2 / Q" + q.qNumber,
