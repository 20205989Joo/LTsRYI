(function initHermaL2E2Round2(global) {
  "use strict";

  if (!global || global.HermaL2E2Round2) return;

  var MODULE_NAME = "HermaL2E2Round2";
  var SCRIPT_NAME = "herma-l2e2_round2.js";
  var STYLE_ID = "herma-l2e2-round2-style";
  ...
  var state = {
    ...
    level: "Basic",
    day: "106",
    quizTitle: "quiz_Grammar_Basic_106_round2",
    rawRows: [],
    questions: [],
    currentIndex: 0,
    results: [],
  ...
  function buildQuestionsFromRows() {
    ...
    state.questions = filtered.map(function (r, idx) {
      ...
      return {
        ...
        title: String(r["Title"] || "").trim() || "Herma L2-E2 Round2",
  ...
  function renderIntro() {
    ...
    area.innerHTML = [
      ...
      "  </div>",
      '  <button class="r2-quiz-btn" style="width:100%; margin-top:12px;" onclick="HermaL2E2Round2.startQuiz()">Start</button>',
      "</div>"
    ].join("\n");
  }
  ...
  function renderQuestion() {
    ...
    area.innerHTML = [
      ...
      '    <button class="r2-quiz-btn" id="submit-btn" onclick="HermaL2E2Round2.submitAnswer()">\uC81C\uCD9C</button>',
      '    <button class="r2-quiz-btn" id="next-btn" onclick="HermaL2E2Round2.goNext()" disabled>\uB2E4\uC74C</button>',
      "  </div>",
      "</div>"
    ].join("\n");
  ...
  function submitAnswer() {
    ...
    state.results.push({
      ...
      word: "Herma L2-E2 Round2 / Q" + q.qNumber,
