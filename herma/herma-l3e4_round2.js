(function initHermaL3E4Round2(global) {
  "use strict";

  if (!global || global.HermaL3E4Round2) return;

  var MODULE_NAME = "HermaL3E4Round2";
  var SCRIPT_NAME = "herma-l3e4_round2.js";
  var STYLE_ID = "herma-l3e4-round2-style";
  ...
  var state = {
    ...
    level: "Basic",
    day: "112",
    quizTitle: "quiz_Grammar_Basic_112_round2",
    rawRows: [],
    questions: [],
    currentIndex: 0,
    results: [],
  ...
  function buildQuestionsFromRows() {
    ...
    state.questions = filtered.map(function (r, idx) {
      ...
      return {
        no: idx + 1,
        qNumber: qNumber,
        title: String(r["Title"] || "").trim() || "Herma L3-E4 Round2",
  ...
  function renderIntro() {
    ...
    area.innerHTML = [
      ...
      "  </div>",
      '  <button class="r32-quiz-btn" style="width:100%; margin-top:12px;" onclick="HermaL3E4Round2.startQuiz()">Start</button>',
      "</div>"
    ].join("\n");
  }
  ...
  function renderQuestion() {
    ...
    area.innerHTML = [
      ...
      '    <button class="r32-quiz-btn" id="submit-btn" onclick="HermaL3E4Round2.submitAnswer()">\uC81C\uCD9C</button>',
      '    <button class="r32-quiz-btn" id="next-btn" onclick="HermaL3E4Round2.goNext()" disabled>\uB2E4\uC74C</button>',
      "  </div>",
      "</div>"
    ].join("\n");
  ...
  function submitAnswer() {
    ...
    state.results.push({
      ...
      word: "Herma L3-E4 Round2 / Q" + q.qNumber,
