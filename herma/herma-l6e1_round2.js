(function initHermaL6E1Round2(global) {
  "use strict";

  if (!global || global.HermaL6E1Round2) return;

  var MODULE_NAME = "HermaL6E1Round2";
  var SCRIPT_NAME = "herma-l6e1_round2.js";
  var STYLE_ID = "herma-l6e1-round2-style";
  var INSTRUCTION_KR = "\uB450 \uBB38\uC7A5\uC744 \uC774\uC5B4\uBCF4\uC138\uC694";
  ...
  var state = {
    ...
    level: "Basic",
    day: "120",
    quizTitle: "quiz_Grammar_Basic_120_round2",
    rawRows: [],
    questions: [],
    currentIndex: 0,
    results: [],
  ...
  function buildQuestionsFromRows() {
    ...
    state.questions = filtered.map(function (r, idx) {
      ...
      return {
        ...
        title: String(r["Title"] || "").trim() || "Herma L6-E1 Round2",
  ...
  function renderIntro() {
    ...
    area.innerHTML = [
      ...
      "    A/B \uBB38\uC7A5\uC744 \uC774\uC5B4\uC11C \uD55C \uBB38\uC7A5\uC73C\uB85C \uC791\uC131\uD558\uC138\uC694.",
      "  </div>",
      '  <div style="font-size:12px;line-height:1.5;color:#2b2b2b;margin-bottom:8px;">',
      "    Total Questions: " + total,
      "  </div>",
      '  <button class="r2-quiz-btn" style="width:100%; margin-top:12px;" onclick="HermaL6E1Round2.startQuiz()">Start</button>',
      "</div>"
    ].join("\n");
  }
  ...
  function renderQuestion() {
    ...
    area.innerHTML = [
      ...
      '    <button class="r2-quiz-btn" id="submit-btn" onclick="HermaL6E1Round2.submitAnswer()">\uC81C\uCD9C</button>',
      '    <button class="r2-quiz-btn" id="next-btn" onclick="HermaL6E1Round2.goNext()" disabled>\uB2E4\uC74C</button>',
      "  </div>",
      "</div>"
    ].join("\n");
  ...
  function submitAnswer() {
    ...
    state.results.push({
      ...
      word: "Herma L6-E1 Round2 / Q" + q.qNumber,
